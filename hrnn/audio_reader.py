            ...
            for nb_audio_copy, wb_audio_copy in zip(nb_audio_list, wb_audio_list):
                ...
                if self.silence_threshold is not None:
                    ...
                    if nb_audio.size ==  0 or wb_audio.size == 0:
                        print('An audio file was dropped because it contains '
                              'only silence. Consider decreasing trim_silence '
                              'threshold, or adjust the volume of the audio.')
